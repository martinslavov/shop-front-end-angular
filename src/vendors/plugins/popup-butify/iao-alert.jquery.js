...
(function( $ ) {
    $.fn.iaoAlert = $.iaoAlert = function(arr) {
        ...
        $('body').append(
            //'<iao-alert-box position="top-left" style="z-index:'+opt.zIndex+'"><iao-alert-start></iao-alert-start></iao-alert-box>' 
            '<iao-alert-box class="'+opt.class+'" position="top-right" style="z-index:'+opt.zIndex+'"><iao-alert-start></iao-alert-start></iao-alert-box>'
           //+ <iao-alert-box position="bottom-right" style="z-index:'+opt.zIndex+'"><iao-alert-start></iao-alert-start></iao-alert-box><iao-alert-box position="bottom-left" style="z-index:'+opt.zIndex+'"><iao-alert-start></iao-alert-start></iao-alert-box>'
           );
